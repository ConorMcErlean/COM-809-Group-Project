...
public class StockList {
   ...
   // Method to see all out of stock items. This method may be used within the program as classes may need to view out
   // of stock items.
   ...
   // we need for other functions. It returns an Item, so you could think of it as a fancy getItem() method.
   ...
   // Method to add an object to the out of stock arrayList, and remove it from the menu so it cannot accidentally be
   // ordered.
   ...
   // Method to remove an object from the out of stock array list. Does the exact opposite of addToOutOfStock() in that
   // it adds an item back into the menu, so it can once more be ordered.
